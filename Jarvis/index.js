...
function takeCommand(message) {
    ...
    else if ( message.includes('tell me about yourself jarvis')) {
        speak("hello sir  my name is jarvis and i am a virtual assistant and i developed by  shivendra sisodia ");
    }
